...
// The user dashboard (/dashboard/user/*) has its own layout with its own sidebar.
// When we detect that path, render children bare so there is no double-wrapping.
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  const pathname = usePathname() || "";

  // User-role paths — delegate fully to the user layout
