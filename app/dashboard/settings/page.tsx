        ...
        <div className="flex-1 min-w-0" style={panel}>
          ...
          {tab === "profile" && (
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="flex items-center justify-center rounded-[14px] text-xl font-bold text-white" style={{ width: 56, height: 56, background: "linear-gradient(135deg,#0e9e7f,#075c4a)" }}>C</div>
                <div>
                  <p className="text-sm font-semibold text-slate-200">Caretaker Admin</p>
                  <p className="text-xs text-slate-500">admin@aquaguard.io</p>
                  <button className="text-[11.5px] font-semibold mt-1" style={{ color: "#3dd4b0" }}>Change photo</button>
                </div>
              </div>

              {[
                { label: "Full name",    placeholder: "Caretaker Admin"     },
                { label: "Email",        placeholder: "admin@aquaguard.io"  },
                { label: "Phone",        placeholder: "+254 700 000 000"    },
                { label: "Community ID", placeholder: "COMM-NAIROBI-001"    },
              ].map((f) => (
                <div key={f.label}>
              ...
              <button
                className="flex items-center gap-2 text-[13px] font-bold text-white mt-2 transition-all"
                style={{ padding: "10px 20px", background: "linear-gradient(135deg,#0e9e7f,#075c4a)", borderRadius: 10, border: "none", cursor: "pointer", boxShadow: "0 4px 16px rgba(14,158,127,0.3)" }}
              >
          ...
          {tab === "security" && (
            <div className="space-y-4">
              ...
              <button className="flex items-center gap-2 text-[13px] font-bold text-white mt-1" style={{ padding: "10px 20px", background: "linear-gradient(135deg,#0e9e7f,#075c4a)", borderRadius: 10, border: "none", cursor: "pointer" }}>
